...
<div class="container d-flex flex-column">
    ...
    <form action="{{route('reviews.store')}}" method="post" class="p-8 " enctype="multipart/form-data">
        @csrf
        <div class="row">
            <!-- <input type="text" class="col-md-12 form-control mb-2"> -->
            @if(session()->has('success'))
            <div class="alert alert-success">
                Reviews has been successful added
            </div>`
            @endif
            @if($errors->first())
        ...
        <div class="row ">
            ...
            <br>
            <input type="text" name="title_job" class="col-md-12 form-control mb-2 ms-2" placeholder="title job">
            <br>
